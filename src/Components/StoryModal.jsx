...
const StoryModal = ({ storyId, visible, onClose }) => {
    ...
    const [story, setStory] = useState({
        id: 0,
        title: '',
        image: 'https://lemonsandletters.com/wp-content/uploads/2022/12/abigail-and-the-long-wool-200x300.jpg',
        readingTime: 0
    })
    ...
    return (
        <Modal animationType='slide' visible={visible} presentationStyle='overFullScreen' onDismiss={onClose}>
